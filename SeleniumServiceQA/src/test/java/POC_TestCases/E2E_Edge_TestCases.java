...
public class E2E_Edge_TestCases extends BaseTest  {
    ...
    String CapablityAlternateID =functionalcomponents.GetRandomnumber();
	...
	String Cockpitusername = functionalcomponents.getdatafromsheet("CockPit", "E2E_Edge_TestCases", "UserName");
	String Cockpitpassword = functionalcomponents.getdatafromsheet("CockPit", "E2E_Edge_TestCases", "Password");
	...
	//EdgeDeginer input
     ...
     // Get Device Sensortype Sensor Capabality Using API for Cockpit 
     @Test (priority=1)
     public void CreateDevicewithgatewayID() throws Exception
     {
      ...
      @Test (priority=2)
      public void CreateCustomoutboundConnectortype() throws Exception {
    		...
    		functionalcomponents.WaitTillTime(5000);
    		 ...
    		 functionalcomponents.WaitTillTime(2000);
   		    // functionalcomponents.ClickOperation(properties.getProperty("uploadejarfile"));
		     functionalcomponents.WaitTillTime(2000);
   		     String filepath =System.getProperty("user.dir")+"/Documents/CSVEnterprisePlugin-3.1909.0-SNAPSHOT.jar";
   		     WebElement upload= driver.findElement(By.cssSelector("input[id='ps_ed_custom_plugin_uploadjar-fu'][type='file']"));
		     ...
		     functionalcomponents.ClickOperation(properties.getProperty("outboundconnectorsearchbutton"));
   		     functionalcomponents.WaitTillTime(5000);
   		     WebElement ele=driver.findElement(By.xpath("//a[@class='sapMLnk sapMLnkMaxWidth']"));
		  ...
		  functionalcomponents.ClearAndSetValue(properties.getProperty("outboundparametername"), "Parametername");
 		  ...
 		  functionalcomponents.WaitTillTime(1000);
   		  functionalcomponents.ClickOperation("//li[text()='"+Parameterdatatype+"']");
   		  functionalcomponents.WaitTillTime(2000);
    ...
    //Create Project with Sensor Profile
  	//Prerequisite- Start the Policyservice  ( Could version ) with tile EdgeDesigner 
      
     @Test (priority=3, dependsOnMethods = { "CreateCustomoutboundConnectortype" })
     public void ProjectCreation() {  	  
	
	 Projectname="Project"+CurrentDateandTime;
	 Project_configname="Config"+CurrentDateandTime;
	 test.log(Status.INFO, "Click on the + Symbol in the bottom of the work center to add the project");
	 functionalcomponents.ClickOperation(properties.getProperty("Projecttile"));
	 functionalcomponents.WaitTillTime(2000);
	 functionalcomponents.waittill_WebElement_getVisible(properties.getProperty("Project_Addbutton"), 90); 
	 functionalcomponents.WaitTillTime(2000);
	 ...
	 if (driver.findElement(By.xpath(properties.getProperty("Create_project"))).isDisplayed())
	  ...
	  functionalcomponents.WaitTillTime(20000);
	  functionalcomponents.waittill_WebElement_getVisible(properties.getProperty("Refresh_button"),200); 
	  ...
	  else
	  {
	   ...
	   //Feature  Compute Sensor Data Models for 1909 version	  
	...
	//Create outputs in the Rule2 for longitude
	 ...
	 @Test(priority=4, dependsOnMethods = { "ProjectCreation" })
	 ...
	 // deployment of configuration & validate operating system for gateway
	  ...
	  functionalcomponents.ClickOperation(properties.getProperty("Edge_Services"));	
	  functionalcomponents.WaitTillTime(5000);
	  functionalcomponents.ClickOperation(properties.getProperty("Service_refresh_btn"));	
	  functionalcomponents.WaitTillTime(7000);
	  functionalcomponents.waittill_WebElement_getVisible(properties.getProperty("Edge_configurations"), 500);
	...
	@Test(priority=5, dependsOnMethods = { "ProjectPublishandDeploymentConfig" })
	 ...
	 @Test(priority=6, dependsOnMethods = { "ProjectPublishandDeploymentConfig" })
	 ...
	 functionalcomponents.scrollToExact(properties.getProperty("Add_optionslsettings"));
	 //1
	...
	//loop 50 times
		...
		/*
		 * //count = count + 1 for(int i=1; i<=50; i++) { String
		 * topicName="measures/"+DeviceAlternateID; String message =
		 * "{ \"sensorTypeAlternateId\":\""+SensorTypeIDAPI+"\","+
		 * "\"capabilityAlternateId\":\""+CapablityAlternateIDAPI+"\","+
		 * "\"sensorAlternateId\":\""+SensorAltID+"\","+ " \"measures\":[  \r\n" +
 ...
 public void GetDeviceMethod() throws Exception {
	  ...
	  String Devicedata = GetAPIData(DeviceBaseurl, Cockpitusername, Cockpitpassword);
	   //System.out.println("body data is"+Devicedata);
...
public void GetCapablityName() throws Exception {
	   CapabiltyBaseURL = CockpitURL+"/iot/core/api/v1/tenant/"+TenantID+"/capabilities?top=1000&skip=0&_=1571049657690"; 
	 ...
	 //  System.out.println("Capablity ID:"+jsonsensortypeeobj.get("id"));
