...
public class RestrictPassword_UIMasking extends PolicyEdgedesignercomponent {
	...
	String PolicyServiceURL = functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "PolicyServiceURL");
	String username = functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "username");
	String password = functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "password");
	String Gatewayno=functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "Gatewayno");
	String Projectpname = functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "project_name");
	String projectdesc=functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "Description");
	String sensortype1  = functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "Sensortype");
	String capablity1  = functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "capabilityname");
	String Property=functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "Property");
	String Min_reading_value=functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "Min_reading_value");
	String average_value  = functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "AverageReading_value"); 
	String Action_name1  = functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "Actionname");
    String Action_desc  = functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "ActionDescription");
    String Action_Type1  = functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "Action_type");
    String protocol_plugin=functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "ProtocolPlugin");
    String Actionmsg=  functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "Action_Message");
    String Receipient_param= functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "Receipient_parameters");
    String Rulename  = functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "RuleName");
	String Ruledesc  = functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "Rule_Desc");
	String Rulecondition  = functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "Rule_condition");
	String filteropt  = functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "Filter");
	String filter_scopevavlue  = functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "Filtervalue");
	String conditiontype  = functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "Condtiontype");
	String sensor_modelname  = functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "Sensormodelname");
	String Plugin_Name  = functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "Plugin_name");
	String Class  = functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "Class");
	
	String Plugin_Name1  = functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "Plugin_name1");
	String Class1  = functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "Class1");
	String Plugin_Name2  = functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "Plugin_name2");
	String Class2  = functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "Class2");
	String Plugin_Name3 = functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "Plugin_name3");
	String Class3  = functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "Class3");
	
	String Name  = functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "Name");
	String Value  = functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "Value");
	String Configname=functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "Configname");
	String DB_UserName=functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "DB_userid");	 
	String DB_Password=functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "DB_pwd");	  
	@Test
	 public void RestrictPassword_UIMasking_Testcase() throws InterruptedException  {
		...
		//Action
		  ...
		  functionalcomponents.WaitTillTime(2000);
			  ...
			  {
				  test.log(Status.PASS, "user is able to add the rulename as : "+Rulename+" "+"and description as"+":"+Ruledesc);
			  } else
			  {
			...
			//  functionalcomponents.ClearAndSetValue(properties.getProperty("MaximumQueueSize"), "1"); 
			 ...
			 //DOWNLOAD THE CONFIGURATION
			  ...
			  //String Passwordvalue  = functionalcomponents.getdatafromsheet("1905", "RestrictPassword_UIMasking_Testcase", "Value");
			  String[] values = RestrictPassword_UIMasking.GetDatafromDownlodedJeson(Configname);
			  for(String i:values)
		      {
	...
	public static String[] GetDatafromDownlodedJeson(String JsonConfigFileName)
	   {
		String[] values = new String[13];
   		String JsonPath=System.getProperty("user.dir")+"/ExportImportFolder/"+JsonConfigFileName+".json";
