...
public class AzureTestCase extends BaseTest {
	...
	public void AzureTestCase_Flow() {
	 	...
	 	String username = functionalcomponents.getdatafromsheet("Policyservice", "AzureTestCase_Flow", "username");
		String password = functionalcomponents.getdatafromsheet("Policyservice", "AzureTestCase_Flow", "password");	
		String AzureStagingURL=functionalcomponents.getdatafromsheet("Policyservice", "AzureTestCase_Flow", "URL");
		String EdgeDevice= functionalcomponents.getdatafromsheet("Policyservice", "AzureTestCase_Flow", "EdgeDevice");
		String Module = functionalcomponents.getdatafromsheet("Policyservice", "AzureTestCase_Flow", "Module");
		String configname=functionalcomponents.getdatafromsheet("Policyservice", "AzureTestCase_Flow", "Name_config");
