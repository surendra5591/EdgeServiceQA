...
public class BEF_WorkOrderCreation extends BaseTest{
	...
	public void TC01_WorkOrderCreation_Flow() {
		...
		//input data from sheet
		 ...
		 String username = functionalcomponents.getdatafromsheet("BEF", "TC01_WorkOrderCreation_Flow", "UserName");
		 String password = functionalcomponents.getdatafromsheet("BEF", "TC01_WorkOrderCreation_Flow", "Password");
		 String Description=functionalcomponents.getdatafromsheet("BEF", "TC01_WorkOrderCreation_Flow", "Description");
		 String MaintanceActivityType=functionalcomponents.getdatafromsheet("BEF", "TC01_WorkOrderCreation_Flow", "MaintanceActivityType");
		 String EquipmentNumber=functionalcomponents.getdatafromsheet("BEF", "TC01_WorkOrderCreation_Flow", "EquipmentNumber");
		 String WorkCenter=functionalcomponents.getdatafromsheet("BEF", "TC01_WorkOrderCreation_Flow", "WorkCenter");

		
		 //Prerequisite-BEF Application working & user has Persistence DB Access
		 test.log(Status.INFO, "Open  BEF URL in Chrome browser");
		 driver.get(properties.getProperty("BEF_URL"));
		 ...
		 functionalcomponents.WaitTillTime(3000);
		// functionalcomponents.JScriptExecutorClick(properties.getProperty("WorkOrderSave_Btn"));
		...
		// System.out.println(Arrays.toString(splitvalues));
		 ...
		 functionalcomponents.WaitTillTime(60000);
		 functionalcomponents.WaitTillTime(60000);
