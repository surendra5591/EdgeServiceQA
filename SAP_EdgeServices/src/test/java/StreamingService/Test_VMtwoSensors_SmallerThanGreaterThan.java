...
public class Test_VMtwoSensors_SmallerThanGreaterThan extends EdgeServicecomponents {
	
	
	@Test
	public void	TC_03_TestVMtwoSensors_SmallerThanGreaterThan_Flow()
	{
		 String username = functionalcomponents.getdatafromsheet("StreamingService", "TC_03_TestVMtwoSensors_SmallerThanGreaterThan_Flow", "UserName");
		 String password = functionalcomponents.getdatafromsheet("StreamingService", "TC_03_TestVMtwoSensors_SmallerThanGreaterThan_Flow", "Password");
		 ...
		 String SensorProfileName=functionalcomponents.getdatafromsheet("StreamingService", "TC_03_TestVMtwoSensors_SmallerThanGreaterThan_Flow", "SensorProfileName");
		 ...
		 String ProductionParameters_Min=functionalcomponents.getdatafromsheet("StreamingService", "TC_03_TestVMtwoSensors_SmallerThanGreaterThan_Flow", "ProductionParameters_Min");

		 functionalcomponents.ClickAndSetValue(properties.getProperty("ProductionParameters_Minimum"), ProductionParameters_Min);
		 String ProductionParameters_Max=functionalcomponents.getdatafromsheet("StreamingService", "TC_03_TestVMtwoSensors_SmallerThanGreaterThan_Flow", "ProductionParameters_Max");
		 ...
		 functionalcomponents.waittill_WebElement_getVisible(properties.getProperty("Sensorprofile_Name"), 50);
		...
		// System.out.println("Profile"+SensorProfile_Name);
		 ...
		 test.log(Status.INFO, "Enter sensor profile name with special characters ");
		 String SensorProfileName1=functionalcomponents.getdatafromsheet("StreamingService", "TC_03_TestVMtwoSensors_SmallerThanGreaterThan_Flow", "SensorProfileName1");
		 functionalcomponents.ClickAndSetValue(properties.getProperty("Sensorprofile_Name"), SensorProfileName1);
		 if(driver.findElement(By.xpath(properties.getProperty("Sensorprofile_Name"))).isDisplayed())
		 {	
			test.log(Status.PASS, "sensor profile name as"+":"+SensorProfileName1+" "+" is saved successfully with special characters");
		 }
		 else 
		 {
			failedDescription(" sensor profile name is not saved successfully with special characters");
		 ...
		 test.log(Status.INFO, "Enter numeric values for the Testing & Production Parameters with the maximum and minimum values");
		 String ProductionParameters_Min1=functionalcomponents.getdatafromsheet("StreamingService", "TC_03_TestVMtwoSensors_SmallerThanGreaterThan_Flow", "ProductionParameters_Min");
		 functionalcomponents.ClickAndSetValue(properties.getProperty("ProductionParameters_Minimum"), ProductionParameters_Min1);
		 String ProductionParameters_Max1=functionalcomponents.getdatafromsheet("StreamingService", "TC_03_TestVMtwoSensors_SmallerThanGreaterThan_Flow", "ProductionParameters_Max1");
		 functionalcomponents.ClickAndSetValue(properties.getProperty("ProductionParameters_Maximum"), ProductionParameters_Max1);
		 if(Integer.parseInt(ProductionParameters_Max1)<2147483647)
		 {	
			test.log(Status.PASS, "Numeric values for the Testing & Production Parameters with the minimum and maximum values are:"+ProductionParameters_Min+","+ProductionParameters_Max1+"  saved and verified Maximum value is not exceed 2147483647.");
		 }
		 else 
		 {
		 ...
		 functionalcomponents.ClickElementfromSectionlist(properties.getProperty("SensorProfile_List"), SensorProfileName1);
		 functionalcomponents.waittill_WebElement_getVisible(properties.getProperty("Sensorprofile_Name"), 20);
		 String SensorProfile_Name1=driver.findElement(By.xpath(properties.getProperty("Sensorprofile_Name"))).getAttribute("value");
		// System.out.println("Profile"+SensorProfile_Name);
		 if(SensorProfileName1.equalsIgnoreCase(SensorProfile_Name1))
		 {	
			test.log(Status.PASS, "Click Save sensor Profile button and verified sensor profile is created successfully with Profile Name"+" :"+SensorProfile_Name1);
		 }
		 else 
		 {
			failedDescription("Click Save sensor Profile button and sensor profile is not created successfully with Profile Name"+":"+SensorProfile_Name1);
		 }
		...
		//Action Creation
			 ...
			 String ActionName=functionalcomponents.getdatafromsheet("StreamingService", "TC_03_TestVMtwoSensors_SmallerThanGreaterThan_Flow", "ActionName");
			 ...
			 String Actiontypevalue=functionalcomponents.getdatafromsheet("StreamingService", "TC_03_TestVMtwoSensors_SmallerThanGreaterThan_Flow", "ActionType");
		 ...
		 */
			 ...
			 test.log(Status.INFO, "Enter a name of the Actions with the different possible options for the name with special characters and numbers");
			 String ActionName1=functionalcomponents.getdatafromsheet("StreamingService", "TC_03_TestVMtwoSensors_SmallerThanGreaterThan_Flow", "ActionName1");
			 ...
			 functionalcomponents.ClickOperation(properties.getProperty("ActionType_Dropdown"));
			 functionalcomponents.WaitTillTime(1000);
			 String Actiontypevalue1=functionalcomponents.getdatafromsheet("StreamingService", "TC_03_TestVMtwoSensors_SmallerThanGreaterThan_Flow", "ActionType1");
			 ...
			 functionalcomponents.waittillElementReadytoclickable(properties.getProperty("SensorProfile_Rulename"), 70);
			...
			// String sensorprofileid=driver.findElement(By.xpath(properties.getProperty("SensorProfile_ID"))).getText();
			 ...
			 String RuleName=functionalcomponents.getdatafromsheet("Rule", "TC_03_TestVMtwoSensors_SmallerThanGreaterThan_Flow", "RuleName");
			 ...
			 {	
				test.log(Status.PASS, "user is able to enter Rule name as"+": "+RuleName+" and Rule Description : "+","+"successfully to add the Rules for the sensor profile.");
			 }
			 else 
			 {
			 ...
			 functionalcomponents.WaitTillTime(2000);
			 String Ruletypevalue=functionalcomponents.getdatafromsheet("Rule", "TC_03_TestVMtwoSensors_SmallerThanGreaterThan_Flow", "RuleType");
			 ...
			 functionalcomponents.WaitTillTime(3000);
			 String ScopLevelvalue=functionalcomponents.getdatafromsheet("Rule", "TC_03_TestVMtwoSensors_SmallerThanGreaterThan_Flow", "ScopLevel");
			...
			test.log(Status.INFO, "verify user is able to select thresholding operator and Thresholding value as well as Maximum Event Frequency value");
			 String ThresholdingValue=functionalcomponents.getdatafromsheet("Rule", "TC_03_TestVMtwoSensors_SmallerThanGreaterThan_Flow", "ThresholdingValue");
			 ...
			 functionalcomponents.WaitTillTime(2000);
			 String ThersholdoperatorValue=functionalcomponents.getdatafromsheet("Rule", "TC_03_TestVMtwoSensors_SmallerThanGreaterThan_Flow", "ThresholdingOperator");
			...
			//Add new Rule for new Sensor Profile
			 test.log(Status.INFO, "Navigate to Sesore Profile and Add rule for sensorprofile by clicking on the + symbol on the screen");
			 functionalcomponents.ClickOperation(properties.getProperty("Sensorprofilerule_Link"));
			 functionalcomponents.WaitTillTime(5000);
			 functionalcomponents.ClickElementfromSectionlist(properties.getProperty("SensorProfile_List"), SensorProfileName1);
			 functionalcomponents.WaitTillTime(2000);
			 functionalcomponents.ClickOperation(properties.getProperty("Add_Newrole_btn"));
			 functionalcomponents.waittill_WebElement_getVisible(properties.getProperty("SensorProfile_Rulename"), 20);
			 if(driver.findElement(By.xpath(properties.getProperty("SensorProfile_Rulename"))).isDisplayed())
			 {	
				test.log(Status.PASS, "user is able to Navigate to Sesore Profile and add the Rules for the sensor profile. A new window is opening with the Add New Rule.");
			 }
			 ...
			 if(driver.findElement(By.xpath(properties.getProperty("SensorProfile_Rulename"))).isDisplayed() )
			 {	
				test.log(Status.PASS, "Verify all the different fields are available the General Information block of Add New Rule" + " i) Sensor Profile ID"+" ii) Sensor Profile Name "+": "+SensorProfile_Name1);
			 }
			 else 
			 {
				failedDescription("user is able to add the Rules for the sensor profile. A new window is opening with the Add New Rule.");
			 ...
			 String RuleName1=functionalcomponents.getdatafromsheet("Rule", "TC_03_TestVMtwoSensors_SmallerThanGreaterThan_Flow", "RuleName1");
			 ...
			 if(driver.findElement(By.xpath(properties.getProperty("Ruletype_Dropdown"))).isDisplayed())
			 {	
				test.log(Status.PASS, "user is able to enter Rule name as"+": "+RuleName1+" and Rule Description:' "+"successfully to add the Rules for the sensor profile.");
			 }
			 else 
			 {
				failedDescription("user is not able to enter Rule name to add the Rules for the sensor profile.");
			 ...
			 functionalcomponents.ClickOperation(properties.getProperty("Ruletype_Dropdown"));
			 functionalcomponents.WaitTillTime(2000);
			 String Ruletypevalue1=functionalcomponents.getdatafromsheet("Rule", "TC_03_TestVMtwoSensors_SmallerThanGreaterThan_Flow", "RuleType1");
			 ...
			 functionalcomponents.ClickOperation(properties.getProperty("ScopeLevel_Dropdown"));
			 functionalcomponents.WaitTillTime(3000);
			 String ScopLevelvalue1=functionalcomponents.getdatafromsheet("Rule", "TC_03_TestVMtwoSensors_SmallerThanGreaterThan_Flow", "ScopLevel1");
			...
			// functionalcomponents.JScriptExecutorClick(properties.getProperty("ScopLevelPart1")+ScopLevelvalue+properties.getProperty("ScopLevelPart2"));
			 ...
			 test.log(Status.INFO, "verify user is able to select thresholding operator and Thresholding value as well as Maximum Event Frequency value");
			 String ThresholdingValue1=functionalcomponents.getdatafromsheet("Rule", "TC_03_TestVMtwoSensors_SmallerThanGreaterThan_Flow", "ThresholdingValue1");
			 functionalcomponents.ClickAndSetValue(properties.getProperty("Thresholding_Value"), ThresholdingValue1);
			 functionalcomponents.ClickOperation(properties.getProperty("Thresholdoperator_dropdown"));
			 functionalcomponents.WaitTillTime(2000);
			 String ThersholdoperatorValue1=functionalcomponents.getdatafromsheet("Rule", "TC_03_TestVMtwoSensors_SmallerThanGreaterThan_Flow", "ThresholdingOperator1");
			...
			//Deleting Sensor Profile and action
		     ...
		     DeleteRuleFromSensorProfile(SensorProfileName1, RuleName1);
		     DeleteSensorProfile(SensorProfileName);
		     DeleteSensorProfile(SensorProfileName1);
