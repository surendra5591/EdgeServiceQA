...
public class Test_VM_Tiered_Critical_SensorTag extends EdgeServicecomponents {
	
	Properties properties = functionalcomponents.getObjectProperties();
	

	@Test
	 public void TC05_Test_VM_Tiered_Critical_SensorTag_Flow()
	 {
		 String username = functionalcomponents.getdatafromsheet("StreamingService", "TC05_Test_VM_Tiered_Critical_SensorTag_Flow", "UserName");
		 String password = functionalcomponents.getdatafromsheet("StreamingService", "TC05_Test_VM_Tiered_Critical_SensorTag_Flow", "Password");
		...
		String ActionName=functionalcomponents.getdatafromsheet("StreamingService", "TC05_Test_VM_Tiered_Critical_SensorTag_Flow", "ActionName");
		String Actiontypevalue=functionalcomponents.getdatafromsheet("StreamingService", "TC05_Test_VM_Tiered_Critical_SensorTag_Flow", "ActionType");
		...
		CreateAction(ActionName, " ", Actiontypevalue, ActionName,  " ");
		 ...
		 String ActionName1=functionalcomponents.getdatafromsheet("StreamingService", "TC05_Test_VM_Tiered_Critical_SensorTag_Flow", "ActionName1");
		 String Actiontypevalue1=functionalcomponents.getdatafromsheet("StreamingService", "TC05_Test_VM_Tiered_Critical_SensorTag_Flow", "ActionType1");
		...
		// String sensorprofileid=driver.findElement(By.xpath(properties.getProperty("SensorProfile_ID"))).getText();
		 ...
		 String RuleName=functionalcomponents.getdatafromsheet("Rule", "TC05_Test_VM_Tiered_Critical_SensorTag_Flow", "RuleName");
		 ...
		 functionalcomponents.WaitTillTime(2000);
		 String Ruletypevalue=functionalcomponents.getdatafromsheet("Rule", "TC05_Test_VM_Tiered_Critical_SensorTag_Flow", "RuleType");
		 ...
		 functionalcomponents.WaitTillTime(2000);
		 String ScopLevelvalue=functionalcomponents.getdatafromsheet("Rule", "TC05_Test_VM_Tiered_Critical_SensorTag_Flow", "ScopLevel");
		 ...
		 else 
		 {
		    ...
		    // String ThresholdingValue=String.valueOf(functionalcomponents.GetRandomnumber());
			 String ThresholdingValue=functionalcomponents.getdatafromsheet("Rule", "TC05_Test_VM_Tiered_Critical_SensorTag_Flow", "ThresholdingValue");
			 ...
			 functionalcomponents.WaitTillTime(2000);
			 String ThersholdoperatorValue=functionalcomponents.getdatafromsheet("Rule", "TC05_Test_VM_Tiered_Critical_SensorTag_Flow", "ThresholdingOperator");
		...
		// String sensorprofileid1=driver.findElement(By.xpath(properties.getProperty("SensorProfile_ID"))).getText();
		 ...
		 String RuleName1=functionalcomponents.getdatafromsheet("Rule", "TC05_Test_VM_Tiered_Critical_SensorTag_Flow", "RuleName1");
		 ...
		 functionalcomponents.ClickOperation(properties.getProperty("Ruletype_Dropdown"));
		 functionalcomponents.WaitTillTime(2000);
		 String Ruletypevalue1=functionalcomponents.getdatafromsheet("Rule", "TC05_Test_VM_Tiered_Critical_SensorTag_Flow", "RuleType1");
		 ...
		 functionalcomponents.ClickOperation(properties.getProperty("ScopeLevel_Dropdown"));
		 functionalcomponents.WaitTillTime(2000);
		 String ScopLevelvalue1=functionalcomponents.getdatafromsheet("Rule", "TC05_Test_VM_Tiered_Critical_SensorTag_Flow", "ScopLevel1");
		 ...
		 else 
		 {
			failedDescription("user is not able to select Ruletype as Value Monitoring & scope level as Sensorprofile from dropdown button");
		     ...
		     test.log(Status.INFO, "verify user is able to select thresholding operator and Thresholding value as well as Maximum Event Frequency value");
		    // String ThresholdingValue=String.valueOf(functionalcomponents.GetRandomnumber());
			 String ThresholdingValue1=functionalcomponents.getdatafromsheet("Rule", "TC05_Test_VM_Tiered_Critical_SensorTag_Flow", "ThresholdingValue1");
			 functionalcomponents.ClickAndSetValue(properties.getProperty("Thresholding_Value"), ThresholdingValue1);
			 functionalcomponents.ClickOperation(properties.getProperty("Thresholdoperator_dropdown"));
			 functionalcomponents.WaitTillTime(2000);
			 String ThersholdoperatorValue1=functionalcomponents.getdatafromsheet("Rule", "TC05_Test_VM_Tiered_Critical_SensorTag_Flow", "ThresholdingOperator1");
