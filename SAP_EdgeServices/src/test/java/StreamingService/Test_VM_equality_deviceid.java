...
public class Test_VM_equality_deviceid extends EdgeServicecomponents{
	Properties properties = functionalcomponents.getObjectProperties();
	  
	
	 @Test
	 public void TC18_Test_VM_equality_deviceid()
	 {
		String username = functionalcomponents.getdatafromsheet("StreamingService", "TC18_Test_VM_equality_deviceid", "UserName");
		String password = functionalcomponents.getdatafromsheet("StreamingService", "TC18_Test_VM_equality_deviceid", "Password");	
		...
		//Prerequisite- Start the StreamingService Gateway service ( Could version )
		 ...
		 String SensorProfileName=functionalcomponents.getdatafromsheet("StreamingService", "TC18_Test_VM_equality_deviceid", "SensorProfileName");
		 ...
		 String ProductionParameters_Min=functionalcomponents.getdatafromsheet("StreamingService", "TC18_Test_VM_equality_deviceid", "ProductionParameters_Min");
		 functionalcomponents.ClickAndSetValue(properties.getProperty("ProductionParameters_Minimum"), ProductionParameters_Min);
		 String ProductionParameters_Max=functionalcomponents.getdatafromsheet("StreamingService", "TC18_Test_VM_equality_deviceid", "ProductionParameters_Max");
		...
		//Action Creation
		 ...
		 String ActionName=functionalcomponents.getdatafromsheet("StreamingService", "TC18_Test_VM_equality_deviceid", "ActionName");
		 ...
		 functionalcomponents.WaitTillTime(3000);
		 String Actiontypevalue=functionalcomponents.getdatafromsheet("StreamingService", "TC18_Test_VM_equality_deviceid", "ActionType");
		 ...
		 //Set Protocols & Create Enterprise Plugin
		  ...
		  //Add Rule for Sensor Profile
			...
			// String sensorprofileid=driver.findElement(By.xpath(properties.getProperty("SensorProfile_ID"))).getText();
			 ...
			 String RuleName=functionalcomponents.getdatafromsheet("Rule", "TC18_Test_VM_equality_deviceid", "RuleName");
			 ...
			 functionalcomponents.WaitTillTime(2000);
			 String Ruletypevalue=functionalcomponents.getdatafromsheet("Rule", "TC18_Test_VM_equality_deviceid", "RuleType");
