...
public class Test_VM_Tiered_Critical_DeviceID_Flow extends EdgeServicecomponents{
	Properties properties = functionalcomponents.getObjectProperties();
	
	@Test
	 public void TC08_Test_VM_Tiered_Critical_DeviceID_Flow()
	 {
		 String username = functionalcomponents.getdatafromsheet("StreamingService", "TC08_Test_VM_Tiered_Critical_DeviceID_Flow", "UserName");
		 String password = functionalcomponents.getdatafromsheet("StreamingService", "TC08_Test_VM_Tiered_Critical_DeviceID_Flow", "Password");
		 ...
		 String SensorProfileName=functionalcomponents.getdatafromsheet("StreamingService", "TC08_Test_VM_Tiered_Critical_DeviceID_Flow", "SensorProfileName");
		 ...
		 String ProductionParameters_Min=functionalcomponents.getdatafromsheet("StreamingService", "TC08_Test_VM_Tiered_Critical_DeviceID_Flow", "ProductionParameters_Min");
		 functionalcomponents.ClickAndSetValue(properties.getProperty("ProductionParameters_Minimum"), ProductionParameters_Min);
		 String ProductionParameters_Max=functionalcomponents.getdatafromsheet("StreamingService", "TC08_Test_VM_Tiered_Critical_DeviceID_Flow", "ProductionParameters_Max");
		 ...
		 String windowParameters_Min=functionalcomponents.getdatafromsheet("StreamingService", "TC08_Test_VM_Tiered_Critical_DeviceID_Flow", "WindowParameters_Min");
		 functionalcomponents.ClickAndSetValue(properties.getProperty("WindowParameters_Minimum"), windowParameters_Min);
		 String windowsize_averaging=functionalcomponents.getdatafromsheet("StreamingService", "TC08_Test_VM_Tiered_Critical_DeviceID_Flow", "windowSize_averaging");
		...
		//Action Creation
		 ...
		 String ActionName=functionalcomponents.getdatafromsheet("StreamingService", "TC08_Test_VM_Tiered_Critical_DeviceID_Flow", "ActionName");
		 ...
		 functionalcomponents.WaitTillTime(3000);
		 String Actiontypevalue=functionalcomponents.getdatafromsheet("StreamingService", "TC08_Test_VM_Tiered_Critical_DeviceID_Flow", "ActionType");
		 ...
		 {	
			 test.log(Status.PASS, "user is able to enter Message of the Actions as: Geaterthan 20 Successfully ");
		 }
		 else 
		 {
		 ...
		 test.log(Status.INFO, "Enter a name of the Actions with the different possible options for the name with special characters and numbers");
		 String ActionName1=functionalcomponents.getdatafromsheet("StreamingService", "TC08_Test_VM_Tiered_Critical_DeviceID_Flow", "ActionName1");
		 ...
		 functionalcomponents.ClickOperation(properties.getProperty("ActionType_Dropdown"));
		 functionalcomponents.WaitTillTime(1000);
		 String Actiontypevalue1=functionalcomponents.getdatafromsheet("StreamingService", "TC08_Test_VM_Tiered_Critical_DeviceID_Flow", "ActionType1");
		 ...
		 if(driver.findElement(By.xpath(properties.getProperty("Action_Parameters"))).isDisplayed())
		 {	
			 test.log(Status.PASS, "user is able to enter Message of the Actions as: Greaterthan 50 successfully ");
		 }
		 else 
		 {
			failedDescription("user is not able to enter Message of the Actions Successfully");
		 ...
		 //Set Protocols & Create Enterprise Plugin
		  ...
		  test.log(Status.INFO, "Navigate to Sesore Profile and Add rule for sensorprofile by clicking on the + symbol on the screen");
			...
			// String sensorprofileid=driver.findElement(By.xpath(properties.getProperty("SensorProfile_ID"))).getText();
			 ...
			 String RuleName=functionalcomponents.getdatafromsheet("Rule", "TC08_Test_VM_Tiered_Critical_DeviceID_Flow", "RuleName");
			 ...
			 functionalcomponents.WaitTillTime(2000);
			 String Ruletypevalue=functionalcomponents.getdatafromsheet("Rule", "TC08_Test_VM_Tiered_Critical_DeviceID_Flow", "RuleType");
			 ...
			 functionalcomponents.WaitTillTime(2000);
			 String ScopLevelvalue=functionalcomponents.getdatafromsheet("Rule", "TC08_Test_VM_Tiered_Critical_DeviceID_Flow", "ScopLevel");
			 ...
			 else 
			 {
				failedDescription("user is not able to select Ruletype as Value Monitoring & scope level as Sensorprofile from dropdown button");
			     ...
			     functionalcomponents.ClickAndSetValue(properties.getProperty("ScopLeel_Value"), "MH02");
			     functionalcomponents.WaitTillTime(2000);
			    ...
			    // String ThresholdingValue=String.valueOf(functionalcomponents.GetRandomnumber());
				 String ThresholdingValue=functionalcomponents.getdatafromsheet("Rule", "TC08_Test_VM_Tiered_Critical_DeviceID_Flow", "ThresholdingValue");
				 ...
				 functionalcomponents.WaitTillTime(2000);
				 String ThersholdoperatorValue=functionalcomponents.getdatafromsheet("Rule", "TC08_Test_VM_Tiered_Critical_DeviceID_Flow", "ThresholdingOperator");
			...
			// String sensorprofileid1=driver.findElement(By.xpath(properties.getProperty("SensorProfile_ID"))).getText();
			 ...
			 String RuleName1=functionalcomponents.getdatafromsheet("Rule", "TC08_Test_VM_Tiered_Critical_DeviceID_Flow", "RuleName1");
			 ...
			 if(driver.findElement(By.xpath(properties.getProperty("Ruletype_Dropdown"))).isDisplayed())
			 {	
				test.log(Status.PASS, "user is able to enter Rule name as"+": "+RuleName1+" and Rule Description as"+": "+"successfully to add the Rules for the sensor profile.");
			 }
			 else 
			 {
				failedDescription("user is not able to enter Rule name to add the Rules for the sensor profile.");
			 ...
			 functionalcomponents.ClickOperation(properties.getProperty("Ruletype_Dropdown"));
			 functionalcomponents.WaitTillTime(2000);
			 String Ruletypevalue1=functionalcomponents.getdatafromsheet("Rule", "TC08_Test_VM_Tiered_Critical_DeviceID_Flow", "RuleType1");
			 ...
			 functionalcomponents.ClickOperation(properties.getProperty("ScopeLevel_Dropdown"));
			 functionalcomponents.WaitTillTime(2000);
			 String ScopLevelvalue1=functionalcomponents.getdatafromsheet("Rule", "TC08_Test_VM_Tiered_Critical_DeviceID_Flow", "ScopLevel1");
			 ...
			 else 
			 {
				failedDescription("user is not able to select Ruletype as Value Monitoring & scope level as Sensorprofile from dropdown button");
			     ...
			     test.log(Status.INFO, "verify user is able to select thresholding operator and Thresholding value as well as Maximum Event Frequency value");
			    // String ThresholdingValue=String.valueOf(functionalcomponents.GetRandomnumber());
				 String ThresholdingValue1=functionalcomponents.getdatafromsheet("Rule", "TC08_Test_VM_Tiered_Critical_DeviceID_Flow", "ThresholdingValue1");
				 functionalcomponents.ClickAndSetValue(properties.getProperty("Thresholding_Value"), ThresholdingValue1);
				 functionalcomponents.ClickOperation(properties.getProperty("Thresholdoperator_dropdown"));
				 functionalcomponents.WaitTillTime(2000);
				 String ThersholdoperatorValue1=functionalcomponents.getdatafromsheet("Rule", "TC08_Test_VM_Tiered_Critical_DeviceID_Flow", "ThresholdingOperator1");
