...
public class Test_VM_Smallerthan_Deviceid extends EdgeServicecomponents{
	Properties properties = functionalcomponents.getObjectProperties();
	
	
	 @Test
	 public void TC10_Test_VM_smallerthan_Deviceid()
	 {
		String username = functionalcomponents.getdatafromsheet("StreamingService", "TC10_Test_VM_smallerthan_DeviceID", "UserName");
		String password = functionalcomponents.getdatafromsheet("StreamingService", "TC10_Test_VM_smallerthan_DeviceID", "Password");	
		...
		//Prerequisite- Start the StreamingService Gateway service ( Could version )
		 ...
		 String SensorProfileName=functionalcomponents.getdatafromsheet("StreamingService", "TC10_Test_VM_smallerthan_DeviceID", "SensorProfileName");
		 ...
		 String ProductionParameters_Min=functionalcomponents.getdatafromsheet("StreamingService", "TC10_Test_VM_smallerthan_DeviceID", "ProductionParameters_Min");
		 functionalcomponents.ClickAndSetValue(properties.getProperty("ProductionParameters_Minimum"), ProductionParameters_Min);
		 String ProductionParameters_Max=functionalcomponents.getdatafromsheet("StreamingService", "TC10_Test_VM_smallerthan_DeviceID", "ProductionParameters_Max");
		 ...
		 String windowParameters_Min=functionalcomponents.getdatafromsheet("StreamingService", "TC10_Test_VM_smallerthan_DeviceID", "WindowParameters_Min");
		 functionalcomponents.ClickAndSetValue(properties.getProperty("WindowParameters_Minimum"), windowParameters_Min);
		 String windowsize_averaging=functionalcomponents.getdatafromsheet("StreamingService", "TC10_Test_VM_smallerthan_DeviceID", "windowSize_averaging");
		...
		//Action Creation
		 ...
		 String ActionName=functionalcomponents.getdatafromsheet("StreamingService", "TC10_Test_VM_smallerthan_DeviceID", "ActionName");
		 ...
		 functionalcomponents.WaitTillTime(3000);
		 String Actiontypevalue=functionalcomponents.getdatafromsheet("StreamingService", "TC10_Test_VM_smallerthan_DeviceID", "ActionType");
		 ...
		 //Set Protocols & Create Enterprise Plugin
		  ...
		  test.log(Status.INFO, "Navigate to Sesore Profile and Add rule for sensorprofile by clicking on the + symbol on the screen");
			...
			// String sensorprofileid=driver.findElement(By.xpath(properties.getProperty("SensorProfile_ID"))).getText();
			 ...
			 String RuleName=functionalcomponents.getdatafromsheet("Rule", "TC10_Test_VM_smallerthan_DeviceID", "RuleName");
			 ...
			 {	
				test.log(Status.PASS, "user is able to enter Rule name as"+": "+RuleName+" and Rule Description as"+": "+" to add the Rules for the sensor profile.");
			 }
			 else 
			 {
			 ...
			 functionalcomponents.WaitTillTime(2000);
			 String Ruletypevalue=functionalcomponents.getdatafromsheet("Rule", "TC10_Test_VM_smallerthan_DeviceID", "RuleType");
			 ...
			 functionalcomponents.WaitTillTime(2000);
			 String ScopLevelvalue=functionalcomponents.getdatafromsheet("Rule", "TC10_Test_VM_smallerthan_DeviceID", "ScopLevel");
			 ...
			 else 
			 {
			    ...
			    // String ThresholdingValue=String.valueOf(functionalcomponents.GetRandomnumber());
				 String ThresholdingValue=functionalcomponents.getdatafromsheet("Rule", "TC10_Test_VM_smallerthan_DeviceID", "ThresholdingValue");
				 ...
				 functionalcomponents.WaitTillTime(2000);
				 String ThersholdoperatorValue=functionalcomponents.getdatafromsheet("Rule", "TC10_Test_VM_smallerthan_DeviceID", "ThresholdingOperator");
