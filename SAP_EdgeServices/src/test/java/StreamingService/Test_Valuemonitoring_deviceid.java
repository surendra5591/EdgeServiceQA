...
public class Test_Valuemonitoring_deviceid  extends EdgeServicecomponents{
	Properties properties = functionalcomponents.getObjectProperties();
	   
	 @Test
	 public void TC20_Test_Valuemonitoring_deviceid()
	 {
		String username = functionalcomponents.getdatafromsheet("StreamingService", "TC20_Test_Valuemonitoring_deviceid", "UserName");
		String password = functionalcomponents.getdatafromsheet("StreamingService", "TC20_Test_Valuemonitoring_deviceid", "Password");	
		...
		//Prerequisite- Start the StreamingService Gateway service ( Could version )
		 ...
		 String SensorProfileName=functionalcomponents.getdatafromsheet("StreamingService", "TC20_Test_Valuemonitoring_deviceid", "SensorProfileName");
		 ...
		 String ProductionParameters_Min=functionalcomponents.getdatafromsheet("StreamingService", "TC20_Test_Valuemonitoring_deviceid", "ProductionParameters_Min");
		 functionalcomponents.ClickAndSetValue(properties.getProperty("ProductionParameters_Minimum"), ProductionParameters_Min);
		 String ProductionParameters_Max=functionalcomponents.getdatafromsheet("StreamingService", "TC20_Test_Valuemonitoring_deviceid", "ProductionParameters_Max");
		 ...
		 String windowParameters_Min=functionalcomponents.getdatafromsheet("StreamingService", "TC20_Test_Valuemonitoring_deviceid", "WindowParameters_Min");
		 functionalcomponents.ClickAndSetValue(properties.getProperty("WindowParameters_Minimum"), windowParameters_Min);
		 String windowsize_averaging=functionalcomponents.getdatafromsheet("StreamingService", "TC20_Test_Valuemonitoring_deviceid", "windowSize_averaging");
		...
		//Action Creation
		 ...
		 String ActionName=functionalcomponents.getdatafromsheet("StreamingService", "TC20_Test_Valuemonitoring_deviceid", "ActionName");
		 ...
		 if(driver.findElement(By.xpath(properties.getProperty("ActionName"))).isDisplayed())
		 {	
			 test.log(Status.PASS, "user is able to enter Description of the Actions Successfully "+": ACTION 1");
		 }
		 else 
		 {
		 ...
		 functionalcomponents.WaitTillTime(3000);
		 String Actiontypevalue=functionalcomponents.getdatafromsheet("StreamingService", "TC20_Test_Valuemonitoring_deviceid", "ActionType");
		 ...
		 {	
			 test.log(Status.PASS, "user is able to enter Message of the Actions as: Action 1 Successfully ");
		 }
		 else 
		 {
		 ...
		 {
			failedDescription("Clicked Save Action button and verified Action is not created successfully with Action Name"+" "+ActionNameValue);
		 }
		 ...
		 //Set Protocols & Create Enterprise Plugin
		  ...
		  //Add Rule for Sensor Profile
			 ...
			 {
				failedDescription("user is not able to Navigate to Sesore Profile and add the Rules for the sensor profile. A new window is opening with the Add New Rule.");
			 }
			 ...
			 String RuleName=functionalcomponents.getdatafromsheet("Rule", "TC20_Test_Valuemonitoring_deviceid", "RuleName");
			 ...
			 functionalcomponents.WaitTillTime(2000);
			 String Ruletypevalue=functionalcomponents.getdatafromsheet("Rule", "TC20_Test_Valuemonitoring_deviceid", "RuleType");
			 System.out.println(Ruletypevalue);
			 ...
			 functionalcomponents.WaitTillTime(2000);
			 String ScopLevelvalue=functionalcomponents.getdatafromsheet("Rule", "TC20_Test_Valuemonitoring_deviceid", "ScopLevel");
		     ...
		     functionalcomponents.WaitTillTime(2000);
			    ...
			    // String ThresholdingValue=String.valueOf(functionalcomponents.GetRandomnumber());
				 String ThresholdingValue=functionalcomponents.getdatafromsheet("Rule", "TC20_Test_Valuemonitoring_deviceid", "ThresholdingValue");
				 ...
				 functionalcomponents.WaitTillTime(2000);
				 String ThersholdoperatorValue=functionalcomponents.getdatafromsheet("Rule", "TC20_Test_Valuemonitoring_deviceid", "ThresholdingOperator");
