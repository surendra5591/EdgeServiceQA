...
public class Test_VM_equality_Tolerance extends EdgeServicecomponents{
	Properties properties = functionalcomponents.getObjectProperties();
	 
	 @Test
	 public void TC17_Test_VM_equality_Tolerance()
	 {
		String username = functionalcomponents.getdatafromsheet("StreamingService", "TC17_Test_VM_equality_Tolerance", "UserName");
		String password = functionalcomponents.getdatafromsheet("StreamingService", "TC17_Test_VM_equality_Tolerance", "Password");	
		...
		//Prerequisite- Start the StreamingService Gateway service ( Could version )
		 ...
		 String SensorProfileName=functionalcomponents.getdatafromsheet("StreamingService", "TC17_Test_VM_equality_Tolerance", "SensorProfileName");
		 ...
		 String ProductionParameters_Min=functionalcomponents.getdatafromsheet("StreamingService", "TC17_Test_VM_equality_Tolerance", "ProductionParameters_Min");
		 functionalcomponents.ClickAndSetValue(properties.getProperty("ProductionParameters_Minimum"), ProductionParameters_Min);
		 String ProductionParameters_Max=functionalcomponents.getdatafromsheet("StreamingService", "TC17_Test_VM_equality_Tolerance", "ProductionParameters_Max");
		 ...
		 String windowParameters_Min=functionalcomponents.getdatafromsheet("StreamingService", "TC17_Test_VM_equality_Tolerance", "WindowParameters_Min");
		 functionalcomponents.ClickAndSetValue(properties.getProperty("WindowParameters_Minimum"), windowParameters_Min);
		 String windowsize_averaging=functionalcomponents.getdatafromsheet("StreamingService", "TC17_Test_VM_equality_Tolerance", "windowSize_averaging");
		...
		//Action Creation
		 ...
		 String ActionName=functionalcomponents.getdatafromsheet("StreamingService", "TC17_Test_VM_equality_Tolerance", "ActionName");
		 ...
		 functionalcomponents.WaitTillTime(3000);
		 String Actiontypevalue=functionalcomponents.getdatafromsheet("StreamingService", "TC17_Test_VM_equality_Tolerance", "ActionType");
		 ...
		 functionalcomponents.ClickAndSetValue(properties.getProperty("Action_Message"), "Equal1");
		 ...
		 //Set Protocols & Create Enterprise Plugin
		  ...
		  //Add Rule for Sensor Profile
			 ...
			 String RuleName=functionalcomponents.getdatafromsheet("Rule", "TC17_Test_VM_equality_Tolerance", "RuleName");
			 ...
			 //functionalcomponents.ClickOperation(properties.getProperty("Chainability"));		 
			 ...
			 functionalcomponents.WaitTillTime(2000);
			 String Ruletypevalue=functionalcomponents.getdatafromsheet("Rule", "TC17_Test_VM_equality_Tolerance", "RuleType");
			 ...
			 functionalcomponents.WaitTillTime(2000);
			 String ScopLevelvalue=functionalcomponents.getdatafromsheet("Rule", "TC17_Test_VM_equality_Tolerance", "ScopLevel");
			 ...
			 else 
			 {
			    ...
			    // String ThresholdingValue=String.valueOf(functionalcomponents.GetRandomnumber());
				 String ThresholdingValue=functionalcomponents.getdatafromsheet("Rule", "TC17_Test_VM_equality_Tolerance", "ThresholdingValue");
