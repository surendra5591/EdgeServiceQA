...
public class Test_VM_equality_Tolerance_DeviceID  extends EdgeServicecomponents{
	Properties properties = functionalcomponents.getObjectProperties();
	
	 @Test
	 public void TC16_Test_VM_equality_Tolerance_DeviceID()
	 {
		String username = functionalcomponents.getdatafromsheet("StreamingService", "TC16_Test_VM_equality_Tolerance_DeviceID", "UserName");
		String password = functionalcomponents.getdatafromsheet("StreamingService", "TC16_Test_VM_equality_Tolerance_DeviceID", "Password");	
		...
		//Prerequisite- Start the StreamingService Gateway service ( Could version )
		 ...
		 String SensorProfileName=functionalcomponents.getdatafromsheet("StreamingService", "TC16_Test_VM_equality_Tolerance_DeviceID", "SensorProfileName");
		 ...
		 String ProductionParameters_Min=functionalcomponents.getdatafromsheet("StreamingService", "TC16_Test_VM_equality_Tolerance_DeviceID", "ProductionParameters_Min");
		 functionalcomponents.ClickAndSetValue(properties.getProperty("ProductionParameters_Minimum"), ProductionParameters_Min);
		 String ProductionParameters_Max=functionalcomponents.getdatafromsheet("StreamingService", "TC16_Test_VM_equality_Tolerance_DeviceID", "ProductionParameters_Max");
		...
		//Action Creation
		 ...
		 String ActionName=functionalcomponents.getdatafromsheet("StreamingService", "TC16_Test_VM_equality_Tolerance_DeviceID", "ActionName");
		 ...
		 functionalcomponents.WaitTillTime(3000);
		 String Actiontypevalue=functionalcomponents.getdatafromsheet("StreamingService", "TC16_Test_VM_equality_Tolerance_DeviceID", "ActionType");
		 ...
		 functionalcomponents.ClickAndSetValue(properties.getProperty("Action_Message"), "Action!");
		 if(driver.findElement(By.xpath(properties.getProperty("Action_Parameters"))).isDisplayed())
		 {	
			 test.log(Status.PASS, "user is able to enter Message of the Actions as: Action! Successfully ");
		 }
		 else 
		 {
		 ...
		 //Set Protocols & Create Enterprise Plugin
		  ...
		  //Add Rule for Sensor Profile
			 ...
			 String RuleName=functionalcomponents.getdatafromsheet("Rule", "TC16_Test_VM_equality_Tolerance_DeviceID", "RuleName");
			...
			// functionalcomponents.ClickOperation(properties.getProperty("Chainability"));		 
			 ...
			 functionalcomponents.WaitTillTime(2000);
			 String Ruletypevalue=functionalcomponents.getdatafromsheet("Rule", "TC16_Test_VM_equality_Tolerance_DeviceID", "RuleType");
			 ...
			 functionalcomponents.WaitTillTime(2000);
			 String ScopLevelvalue=functionalcomponents.getdatafromsheet("Rule", "TC16_Test_VM_equality_Tolerance_DeviceID", "ScopLevel");
