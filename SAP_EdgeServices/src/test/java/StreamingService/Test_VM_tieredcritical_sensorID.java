...
public class Test_VM_tieredcritical_sensorID extends EdgeServicecomponents {
	Properties properties = functionalcomponents.getObjectProperties();
	
	@Test
	 public void TC06_Test_VM_Tiered_Critical_SensorID_Flow()
	 {
		 String username = functionalcomponents.getdatafromsheet("StreamingService", "TC06_Test_VM_Tiered_Critical_SensorID_Flow", "UserName");
		 String password = functionalcomponents.getdatafromsheet("StreamingService", "TC06_Test_VM_Tiered_Critical_SensorID_Flow", "Password");
		...
		test.log(Status.INFO, "Login Streaming service and Click on Sensor profile on the workcenter at left of the screen");
		 ...
		 String SensorProfileName=functionalcomponents.getdatafromsheet("StreamingService", "TC06_Test_VM_Tiered_Critical_SensorID_Flow", "SensorProfileName");
		 ...
		 String ProductionParameters_Min=functionalcomponents.getdatafromsheet("StreamingService", "TC06_Test_VM_Tiered_Critical_SensorID_Flow", "ProductionParameters_Min");
		 functionalcomponents.ClickAndSetValue(properties.getProperty("ProductionParameters_Minimum"), ProductionParameters_Min);
		 String ProductionParameters_Max=functionalcomponents.getdatafromsheet("StreamingService", "TC06_Test_VM_Tiered_Critical_SensorID_Flow", "ProductionParameters_Max");
		 ...
		 String windowParameters_Min=functionalcomponents.getdatafromsheet("StreamingService", "TC06_Test_VM_Tiered_Critical_SensorID_Flow", "WindowParameters_Min");
		 functionalcomponents.ClickAndSetValue(properties.getProperty("WindowParameters_Minimum"), windowParameters_Min);
		 String windowsize_averaging=functionalcomponents.getdatafromsheet("StreamingService", "TC06_Test_VM_Tiered_Critical_SensorID_Flow", "windowSize_averaging");
		...
		//Action Creation
		 ...
		 String ActionName=functionalcomponents.getdatafromsheet("StreamingService", "TC06_Test_VM_Tiered_Critical_SensorID_Flow", "ActionName");
		 ...
		 functionalcomponents.WaitTillTime(3000);
		 String Actiontypevalue=functionalcomponents.getdatafromsheet("StreamingService", "TC06_Test_VM_Tiered_Critical_SensorID_Flow", "ActionType");
		 ...
		 test.log(Status.INFO, "Enter a name of the Actions with the different possible options for the name with special characters and numbers");
		 String ActionName1=functionalcomponents.getdatafromsheet("StreamingService", "TC06_Test_VM_Tiered_Critical_SensorID_Flow", "ActionName1");
		 ...
		 functionalcomponents.ClickOperation(properties.getProperty("ActionType_Dropdown"));
		 functionalcomponents.WaitTillTime(1000);
		 String Actiontypevalue1=functionalcomponents.getdatafromsheet("StreamingService", "TC06_Test_VM_Tiered_Critical_SensorID_Flow", "ActionType1");
		 ...
		 //Rule creation 
		  test.log(Status.INFO, "Navigate to Sesore Profile and Add rule for sensorprofile by clicking on the + symbol on the screen");
			...
			// String sensorprofileid=driver.findElement(By.xpath(properties.getProperty("SensorProfile_ID"))).getText();
			 ...
			 String RuleName=functionalcomponents.getdatafromsheet("Rule", "TC06_Test_VM_Tiered_Critical_SensorID_Flow", "RuleName");
			 ...
			 functionalcomponents.WaitTillTime(2000);
			 String Ruletypevalue=functionalcomponents.getdatafromsheet("Rule", "TC06_Test_VM_Tiered_Critical_SensorID_Flow", "RuleType");
			 ...
			 functionalcomponents.WaitTillTime(2000);
			 String ScopLevelvalue=functionalcomponents.getdatafromsheet("Rule", "TC06_Test_VM_Tiered_Critical_SensorID_Flow", "ScopLevel");
			 ...
			 else 
			 {
			    ...
			    // String ThresholdingValue=String.valueOf(functionalcomponents.GetRandomnumber());
				 String ThresholdingValue=functionalcomponents.getdatafromsheet("Rule", "TC06_Test_VM_Tiered_Critical_SensorID_Flow", "ThresholdingValue");
				 ...
				 functionalcomponents.WaitTillTime(2000);
				 String ThersholdoperatorValue=functionalcomponents.getdatafromsheet("Rule", "TC06_Test_VM_Tiered_Critical_SensorID_Flow", "ThresholdingOperator");
			...
			// String sensorprofileid1=driver.findElement(By.xpath(properties.getProperty("SensorProfile_ID"))).getText();
			 ...
			 String RuleName1=functionalcomponents.getdatafromsheet("Rule", "TC06_Test_VM_Tiered_Critical_SensorID_Flow", "RuleName1");
			 ...
			 functionalcomponents.ClickOperation(properties.getProperty("Ruletype_Dropdown"));
			 functionalcomponents.WaitTillTime(2000);
			 String Ruletypevalue1=functionalcomponents.getdatafromsheet("Rule", "TC06_Test_VM_Tiered_Critical_SensorID_Flow", "RuleType1");
			 ...
			 functionalcomponents.ClickOperation(properties.getProperty("ScopeLevel_Dropdown"));
			 functionalcomponents.WaitTillTime(2000);
			 String ScopLevelvalue1=functionalcomponents.getdatafromsheet("Rule", "TC06_Test_VM_Tiered_Critical_SensorID_Flow", "ScopLevel1");
			 ...
			 else 
			 {
				failedDescription("user is not able to select Ruletype as Value Monitoring & scope level as Sensorprofile from dropdown button");
			     ...
			     test.log(Status.INFO, "verify user is able to select thresholding operator and Thresholding value as well as Maximum Event Frequency value");
			    // String ThresholdingValue=String.valueOf(functionalcomponents.GetRandomnumber());
				 String ThresholdingValue1=functionalcomponents.getdatafromsheet("Rule", "TC06_Test_VM_Tiered_Critical_SensorID_Flow", "ThresholdingValue1");
				 functionalcomponents.ClickAndSetValue(properties.getProperty("Thresholding_Value"), ThresholdingValue1);
				 functionalcomponents.ClickOperation(properties.getProperty("Thresholdoperator_dropdown"));
				 functionalcomponents.WaitTillTime(2000);
				 String ThersholdoperatorValue1=functionalcomponents.getdatafromsheet("Rule", "TC06_Test_VM_Tiered_Critical_SensorID_Flow", "ThresholdingOperator1");
