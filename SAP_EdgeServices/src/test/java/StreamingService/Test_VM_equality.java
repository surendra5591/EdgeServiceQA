...
public class Test_VM_equality extends EdgeServicecomponents{
	Properties properties = functionalcomponents.getObjectProperties();
	   
	 @Test
	 public void TC19_Test_VM_equality()
	 {
		String username = functionalcomponents.getdatafromsheet("StreamingService", "TC19_Test_VM_equality", "UserName");
		String password = functionalcomponents.getdatafromsheet("StreamingService", "TC19_Test_VM_equality", "Password");	
		...
		//Prerequisite- Start the StreamingService Gateway service ( Could version )
		 ...
		 String SensorProfileName=functionalcomponents.getdatafromsheet("StreamingService", "TC19_Test_VM_equality", "SensorProfileName");
		 ...
		 String ProductionParameters_Min=functionalcomponents.getdatafromsheet("StreamingService", "TC19_Test_VM_equality", "ProductionParameters_Min");
		 functionalcomponents.ClickAndSetValue(properties.getProperty("ProductionParameters_Minimum"), ProductionParameters_Min);
		 String ProductionParameters_Max=functionalcomponents.getdatafromsheet("StreamingService", "TC19_Test_VM_equality", "ProductionParameters_Max");
		 ...
		 String windowParameters_Min=functionalcomponents.getdatafromsheet("StreamingService", "TC19_Test_VM_equality", "WindowParameters_Min");
		 functionalcomponents.ClickAndSetValue(properties.getProperty("WindowParameters_Minimum"), windowParameters_Min);
		 String windowsize_averaging=functionalcomponents.getdatafromsheet("StreamingService", "TC19_Test_VM_equality", "windowSize_averaging");
		...
		//Action Creation
		 ...
		 String ActionName=functionalcomponents.getdatafromsheet("StreamingService", "TC19_Test_VM_equality", "ActionName");
		 ...
		 functionalcomponents.WaitTillTime(3000);
		 String Actiontypevalue=functionalcomponents.getdatafromsheet("StreamingService", "TC19_Test_VM_equality", "ActionType");
		 ...
		 {	
			 test.log(Status.PASS, "user is able to enter Message of the Actions as: Equals 60 Successfully ");
		 }
		 else 
		 {
		 ...
		 //Set Protocols & Create Enterprise Plugin
		  ...
		  //Add Rule for Sensor Profile
			...
			// String sensorprofileid=driver.findElement(By.xpath(properties.getProperty("SensorProfile_ID"))).getText();
			 ...
			 String RuleName=functionalcomponents.getdatafromsheet("Rule", "TC19_Test_VM_equality", "RuleName");
			 ...
			 functionalcomponents.WaitTillTime(2000);
			 String Ruletypevalue=functionalcomponents.getdatafromsheet("Rule", "TC19_Test_VM_equality", "RuleType");
			 ...
			 functionalcomponents.WaitTillTime(2000);
			 String ScopLevelvalue=functionalcomponents.getdatafromsheet("Rule", "TC19_Test_VM_equality", "ScopLevel");
			 ...
			 else 
			 {
			    ...
			    // String ThresholdingValue=String.valueOf(functionalcomponents.GetRandomnumber());
				 String ThresholdingValue=functionalcomponents.getdatafromsheet("Rule", "TC19_Test_VM_equality", "ThresholdingValue");
				 ...
				 functionalcomponents.WaitTillTime(2000);
				 String ThersholdoperatorValue=functionalcomponents.getdatafromsheet("Rule", "TC19_Test_VM_equality", "ThresholdingOperator");
