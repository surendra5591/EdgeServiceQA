...
class E2E_Cockpit_Testcases extends BaseTest  {
	 
	    Properties properties = functionalcomponents.getObjectProperties();
	    String PolicyServiceURL = functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "PolicyServiceURL");
	    String username = functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "username");
	    String password = functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "password");
	    String Tenant=functionalcomponents.getdatafromsheet("CockPit", "E2E_Cockpit_Testcase_Flow", "Tenant");
	    String GateWayNo = functionalcomponents.getdatafromsheet("CockPit", "E2E_Cockpit_Testcase_Flow", "GateWayNo");
	    String Project_configname=functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "Project_configname");
	    String DB_UserName=functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "DB_userid");	 
	    String DB_Password=functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "DB_pwd");	  

	 @Test(priority =0)
	 public void E2E_Cockpit_Testcase_Flow() throws InterruptedException, MqttPersistenceException, MqttException
	 {
		String CockpitURL= functionalcomponents.getdatafromsheet("CockPit", "E2E_Cockpit_Testcase_Flow", "CockpitURL");
		String user = functionalcomponents.getdatafromsheet("CockPit", "E2E_Cockpit_Testcase_Flow", "UserName");
		...
		String username = functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "username");
		String password = functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "password");
		String Projectpname = functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "project_name");
		String projectdesc=functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "Description");
		String Project_configname=functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "Project_configname"); 
		String average_value  = functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "AverageReading_value");
		String Minimum_output_frequency= functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "Minimum_output_frequency");
		String Keep_events_Days=functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "Keep_events_Days");
		String Max_edge_Readings_store=functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "Max_edge_Readings_store");
		String Enterprise_max_output_frequency=functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "Enterprise_max_output_frequency");
		String Local_enterpriseplugin=functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "Local_enterprise_plugin");
		String Rulename  = functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "RuleName");
		String Ruledesc  = functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "Rule_Desc");
		String Rulecondition  = functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "Rule_condition");
		String RuleMaxfrequency=  functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "RuleMaxoutfrequency");
		String Rulename1  = functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "RuleName1");
		String Ruledesc1  = functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "Rule_Desc1");
		String Rulecondition1  = functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "Rule_condition1");
		String filteropt  = functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "Filter");
		String filtervalue  = functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "Filtervalue");
		String conditiontype  = functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "Condtiontype");
		String sensor_modelname  = functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "Sensormodelname");
		String customproject_host=functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "Customprojecthost");
		String customproject_port=functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "customprojectport");
		String maximum_eventfrequency1=functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "Max_eventfrequency");
		String interval_without_sensor=functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "intervalwithoutsensor");
		String Targetstate=functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "Targetstate");
		String Timein_State=functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "Timeinstate");
		String operator  = functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "Operator");
		String thresholding_value  = functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "Thresholdingvalue");
		String Actionname  = functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "Actionname");
	    String Action_desc  = functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "ActionDescription");
	    String Actionname1  = functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "Actionname1");
	    String Action_desc1  = functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "ActionDescription1");
	    String Action_type  = functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "Action_type");
	    String protocol_plugin=functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "ProtocolPlugin");
	    String Actionmsg=  functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "Action_Message");
	    String Receipient_param= functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "Receipient_parameters");
	    String Scope_level  = functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "Scope_level");
	    String Edge_Fedilityfreq  = functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "New_edgefedility_freq");
	    String Edge_fedility_rollback = functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "edge_fedility_rollback");
	    String enterprise_fedility = functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "Enterprise_fedility");
	    String enterprise_rollback  = functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "Enterprise_rollback");
	    String Edge_Fedilityfreq1  = functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "New_edgefedility_freq1");
	    String Edge_fedility_rollback1 = functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "edge_fedility_rollback1");
	    String enterprise_fedility1 = functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "Enterprise_fedility1");
	    String enterprise_rollback1  = functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "Enterprise_rollback1");
	    String DB_UserName=functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "DB_userid");	 
	    String DB_Password=functionalcomponents.getdatafromsheet("EdgeDesigner", "E2E_Cockpit_Testcase_Flow", "DB_pwd");	  

		//Streaming input
	    String Plugin_name=functionalcomponents.getdatafromsheet("CockPit", "E2E_Cockpit_Testcase_Flow", "Plugin_name");
	    String FIDELITY_AUTHENTICATION_input=functionalcomponents.getdatafromsheet("CockPit", "E2E_Cockpit_Testcase_Flow", "FIDELITY_AUTHENTICATION_input");
	    String FIDELITY_AUTH_TYPE_input=functionalcomponents.getdatafromsheet("CockPit", "E2E_Cockpit_Testcase_Flow", "FIDELITY_AUTH_TYPE_input");
	    String FIDELITY_URI_input=functionalcomponents.getdatafromsheet("CockPit", "E2E_Cockpit_Testcase_Flow", "FIDELITY_URI_input");
		String FIDELITY_USERNAME_input=functionalcomponents.getdatafromsheet("CockPit", "E2E_Cockpit_Testcase_Flow", "FIDELITY_USERNAME_input");
		String ENTERPRISE_EVENT_AUTH_TYPE_input=functionalcomponents.getdatafromsheet("CockPit", "E2E_Cockpit_Testcase_Flow", "ENTERPRISE_EVENT_AUTH_TYPE_input");
		String ENTERPRISE_EVENT_AUTHENTICATION_input=functionalcomponents.getdatafromsheet("CockPit", "E2E_Cockpit_Testcase_Flow", "ENTERPRISE_EVENT_AUTHENTICATION_input");
		String ENTERPRISE_EVENT_URI_input=functionalcomponents.getdatafromsheet("CockPit", "E2E_Cockpit_Testcase_Flow", "ENTERPRISE_EVENT_URI_input");
		String ENTERPRISE_EVENT_USERNAME_input=functionalcomponents.getdatafromsheet("CockPit", "E2E_Cockpit_Testcase_Flow", "ENTERPRISE_EVENT_USERNAME_input");
		...
		functionalcomponents.ClickOperation((properties.getProperty("device_link_part1")+DeviceName+properties.getProperty("device_link_part2")));
		functionalcomponents.WaitTillTime(5000); 
		functionalcomponents.ClearAndSetValue(properties.getProperty("Sensor_search"), SensorName);
		functionalcomponents.WaitTillTime(3000);
		functionalcomponents.ClickOperation((properties.getProperty("device_link_part1")+SensorName+properties.getProperty("device_link_part2")));
		functionalcomponents.WaitTillTime(5000); 
		WebElement Sensor_ele = driver.findElement(By.xpath("//div[contains(@id,'expand-heading-wrapper')]//span[text()='"+SensorName+"']"));
		...
		//Create outputs in the Rule2 for longitude
		 ...
		 // Accessing sensor model data from db
		  ...
		  String Streamingusername = functionalcomponents.getdatafromsheet("CockPit", "E2E_Cockpit_Testcase_Flow", "Stream_username");
		  String Streamingpassword = functionalcomponents.getdatafromsheet("CockPit", "E2E_Cockpit_Testcase_Flow", "Stream_password");
		...
		//count = count + 1
		 for(int i=1; i<=50; i++) {
		String topicName = functionalcomponents.getdatafromsheet("CockPit", "E2E_Cockpit_Testcase_Flow", "Measure");
