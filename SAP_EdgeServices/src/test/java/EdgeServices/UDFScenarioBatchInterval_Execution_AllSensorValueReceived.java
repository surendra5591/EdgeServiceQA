...
public class UDFScenarioBatchInterval_Execution_AllSensorValueReceived extends BaseTest{
	...
	/*
	 * Scenario: Batch-Interval 
	 * 			 Execution: All Sensor Value Received
	 */
	...
	public void CreateUDF()
	{
		 ...
		 if (functionalcomponents.IsElementDisplayed(properties.getProperty("Create_project")))
		  ...
		  functionalcomponents.ClickOperation(properties.getProperty("UDF_BatchModeDropdown_Interval"));
		 
		  functionalcomponents.ClickOperation(properties.getProperty("UDF_BatchMode_IntervalField"));
		  functionalcomponents.ClearAndSetValue(properties.getProperty("UDF_BatchMode_IntervalField"),"5");
		  functionalcomponents.WaitTillTime(2000);
		  ...
		  functionalcomponents.ClickOperation(properties.getProperty("UDF_ExecutionModeDropdown_AllSensorValueReceived"));
		  functionalcomponents.WaitTillTime(2000);
