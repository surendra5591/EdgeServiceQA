...
public class PersistenceServiceDataRetension extends PolicyEdgedesignercomponent {
	...
	public void PersistenceService_DataRetension_flow() throws Exception {
		String EdgeURL = functionalcomponents.getdatafromsheet("EdgeServices", "PersistenceService_DataRetension_flow", "EdgeURL"); 
		String username = functionalcomponents.getdatafromsheet("EdgeServices", "PersistenceService_DataRetension_flow", "username");
		String password = functionalcomponents.getdatafromsheet("EdgeServices", "PersistenceService_DataRetension_flow", "password");
		String gatewayno=functionalcomponents.getdatafromsheet("EdgeServices", "PersistenceService_DataRetension_flow", "Gatewayno");		
