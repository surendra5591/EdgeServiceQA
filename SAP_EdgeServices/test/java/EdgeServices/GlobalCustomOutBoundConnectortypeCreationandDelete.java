...
public class GlobalCustomOutBoundConnectortypeCreationandDelete extends BaseTest  {
     ...
     public void CreateCustomoutboundConnectortypeandDeleting() throws Exception {
		...
		functionalcomponents.WaitTillTime(7000);
		 ...
		 else 
		 {
   		 ...
   		 test.log(Status.INFO, " Click on Edge designer tile of the Home Page and Click on custom setting on left side and add custom outbound connector type");
